...
# pero que quede claro que lo que no funciona es la referencia por orden a un elemento de un conjunto!
for i in range(len(profesSegundo)):
    print(i)
...
# las conversiones de conjunto a lista, tupla o str también funcionan
